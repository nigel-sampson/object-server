...
namespace UnitTests.RelationshipTests
{
	...
	public class DefinedRelationshipTests  : ServicedComponent
	{
		...
		public void SelectChild()
		{
			...
			DefinedChildTestObject child = transaction.Select(typeof(DefinedChildTestObject), "ChildKey1") as DefinedChildTestObject;
		...
		public void InsertParent()
		{
			...
			DefinedParentTestObject parent = transaction.Create(typeof(DefinedParentTestObject), "testkey1") as DefinedParentTestObject;
			parent.ObjData = "test";
			Assert.AreEqual(0, parent.ChildObjects.Count);
		...
		[Test]
		[ExpectedException(typeof(ObjectServerException), "UnitTests.TestObjects.DefinedChildTestObject.Parent has no value")]
		...
		public void ShiftParents()
		{
			...
			DefinedParentTestObject parent1 = transaction1.Select(typeof(DefinedParentTestObject), "Key1") as DefinedParentTestObject;
			DefinedParentTestObject parent2 = transaction1.Select(typeof(DefinedParentTestObject), "Key2") as DefinedParentTestObject;
		...
		[Test]
		[ExpectedException(typeof(ObjectServerException), "Could not delete, UnitTests.TestObjects.DefinedChildTestObject.Parent has DeleteAction.Throw")]
